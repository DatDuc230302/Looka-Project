                            ...
                            {imgs.map((item, index) => (
                                <div key={index} className={cx('box-empty', mobile && 'mobile')}>
                                    <img
                                        ...
                                        src={
                                            'https://firebasestorage.googleapis.com/v0/b/storage-imgs.appspot.com/o/Food%2Fdownload%20(10).jpeg?alt=media&token=ec04f889-2b44-48f4-8079-ba89dbec31a3'
                                        }
                                        alt=""
                                    />
                                    <div className={cx('buy')}>
                                        ...
                                        <div className={cx('buy-heart')} onClick={() => console.log('Hi')}>
                                            {imgs[index].liked ? (
                                                <svg
                                                    width="20px"
                                                    height="17px"
